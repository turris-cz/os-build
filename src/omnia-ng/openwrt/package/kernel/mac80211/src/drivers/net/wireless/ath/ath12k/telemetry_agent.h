...
#define DETER_MAX_SUB_BUFFERS 1
#define ADMCTRL_MAX_SUB_BUFFERS 1
#define PMLO_MAX_SUB_BUFFERS 1
#define ERP_MAX_SUB_BUFFERS 1
#define ENERGY_SVC_MAX_SUB_BUFFERS 1
