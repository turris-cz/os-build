...
releases can be in versioned directories and binary branches could be just a
symlinks to the correct version. We need to test this idea a little more and
more in detail and then extend this documentation.
...
stuff we are planning to realease. Should be ever more stable just a little
